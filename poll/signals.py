...
def create_cron_schedule_on_poll_creation(sender, instance, created, **kwargs):
    ...
    poll_start_time = instance.poll_start_time
    ...
    if created:
        ...
        periodic_task = PeriodicTask.objects.create(
            ...
            args=json.dumps([str(poll_start_time),str(poll_end_time), str(event_time), poll_text, str(days_until_event_after_poll)])
        )
